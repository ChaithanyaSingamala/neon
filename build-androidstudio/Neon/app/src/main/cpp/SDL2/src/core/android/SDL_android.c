...
/* Drop file */
JNIEXPORT void JNICALL Java_com_xiphos_neon_SDLActivity_onNativeDropFile(
...
/* Resize */
JNIEXPORT void JNICALL Java_com_xiphos_neon_SDLActivity_onNativeResize(
                                    JNIEnv* env, jclass jcls,
...
/* Paddown */
JNIEXPORT jint JNICALL Java_com_xiphos_neon_SDLActivity_onNativePadDown(
                                    JNIEnv* env, jclass jcls,
...
/* Padup */
JNIEXPORT jint JNICALL Java_com_xiphos_neon_SDLActivity_onNativePadUp(
                                   JNIEnv* env, jclass jcls,
                                   jint device_id, jint keycode)
{
...
/* Joy */
JNIEXPORT void JNICALL Java_com_xiphos_neon_SDLActivity_onNativeJoy(
                                    JNIEnv* env, jclass jcls,
...
/* POV Hat */
JNIEXPORT void JNICALL Java_com_xiphos_neon_SDLActivity_onNativeHat(
                                    JNIEnv* env, jclass jcls,
...
JNIEXPORT jint JNICALL Java_com_xiphos_neon_SDLActivity_nativeAddJoystick(
    JNIEnv* env, jclass jcls,
...
JNIEXPORT jint JNICALL Java_com_xiphos_neon_SDLActivity_nativeRemoveJoystick(
...
/* Surface Created */
JNIEXPORT void JNICALL Java_com_xiphos_neon_SDLActivity_onNativeSurfaceChanged(JNIEnv* env, jclass jcls)
{
    SDL_WindowData *data;
...
/* Surface Destroyed */
JNIEXPORT void JNICALL Java_com_xiphos_neon_SDLActivity_onNativeSurfaceDestroyed(JNIEnv* env, jclass jcls)
{
...
/* Keydown */
JNIEXPORT void JNICALL Java_com_xiphos_neon_SDLActivity_onNativeKeyDown(
...
/* Keyup */
JNIEXPORT void JNICALL Java_com_xiphos_neon_SDLActivity_onNativeKeyUp(
                                    JNIEnv* env, jclass jcls, jint keycode)
{
...
/* Keyboard Focus Lost */
JNIEXPORT void JNICALL Java_com_xiphos_neon_SDLActivity_onNativeKeyboardFocusLost(
                                    JNIEnv* env, jclass jcls)
{
...
/* Touch */
JNIEXPORT void JNICALL Java_com_xiphos_neon_SDLActivity_onNativeTouch(
                                    JNIEnv* env, jclass jcls,
...
/* Mouse */
JNIEXPORT void JNICALL Java_com_xiphos_neon_SDLActivity_onNativeMouse(
                                    JNIEnv* env, jclass jcls,
...
/* Accelerometer */
JNIEXPORT void JNICALL Java_com_xiphos_neon_SDLActivity_onNativeAccel(
                                    JNIEnv* env, jclass jcls,
...
/* Low memory */
JNIEXPORT void JNICALL Java_com_xiphos_neon_SDLActivity_nativeLowMemory(
...
/* Quit */
JNIEXPORT void JNICALL Java_com_xiphos_neon_SDLActivity_nativeQuit(
                                    JNIEnv* env, jclass cls)
{
...
/* Pause */
JNIEXPORT void JNICALL Java_com_xiphos_neon_SDLActivity_nativePause(
                                    JNIEnv* env, jclass cls)
{
...
/* Resume */
JNIEXPORT void JNICALL Java_com_xiphos_neon_SDLActivity_nativeResume(
                                    JNIEnv* env, jclass cls)
{
...
JNIEXPORT jstring JNICALL Java_com_xiphos_neon_SDLActivity_nativeGetHint(JNIEnv* env, jclass cls, jstring name) {
