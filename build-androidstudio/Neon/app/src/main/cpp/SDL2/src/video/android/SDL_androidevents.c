...
Android_PumpEvents(_THIS)
{
    ...
    /*
     * Android_ResumeSem and Android_PauseSem are signaled from Java_com_xiphos_neon_SDLActivity_nativePause and Java_com_xiphos_neon_SDLActivity_nativeResume
